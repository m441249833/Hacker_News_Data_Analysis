...
print("Applying data to model-2018......")

f = open("model-2018.txt", "r", encoding="utf-8")
lines = f.readlines()
training_model = {}
for line in lines:
    l = line.split()
...
print("Generating result baseline-result.txt......")
f = open("baseline-result.txt", "w", encoding="utf-8")
...
f.close()
print("baseline-result.txt generated.")